...
/**
 * Servlet implementation class EmployeeInfomation
 */
public class EmployeeInfomation extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		EmployeeInfoCtrl data = new EmployeeInfoCtrl();
		if(responseBodyStr.isEmpty()) {
			try {
				result.putAll(data.Employee_info());
