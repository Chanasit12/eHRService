...
public class TimeSheetCtrl {
	...
	public Map<String, Object> Show_Time_Sheet(int id) throws SQLException, ClassNotFoundException {
		...
		List<Map<String, Object>> Time_sheet = new ArrayList<Map<String, Object>>();
...
//			Time_sheet = dbutil.selectArray(connection,"timesheet","Emp_id",emp_id);
			...
			if(Time_sheet != null) {
				for(Map<String,Object> temp : Time_sheet) {
					Map<String, Object> ans = new HashMap<String, Object>();
					Timesheet_model.setModel(temp);
//					String start = Timesheet_model.getStart().toString();
//					String end = Timesheet_model.getEnd().toString();
...
//					Date End = formatter1.parse(end);
					...
					ans.put("End_at", Timesheet_model.getEnd());
					ans.put("Date", Timesheet_model.getDate());
					if(Timesheet_model.getDetail() == "") {
						ans.put("Detail", "");
					}else {
						ans.put("Detail", Timesheet_model.getDetail());
					}
					if(Timesheet_model.getRemark() == "") {
						ans.put("Remark", "");
	...
	public Map<String, Object> Updated_Time_Sheet(Map<String, Object> data) 
			throws SQLException, ClassNotFoundException, ParseException {
		DatabaseUtil dbutil = new DatabaseUtil();
		Connection connection = dbutil.connectDB();
		Map<String, Object> responseBodyStr = new HashMap<String, Object>();
		Map<String, Object> Sheet_detail = new HashMap<String, Object>();
		TimeSheetModel Timesheet_model = new TimeSheetModel();
	...
	public Map<String, Object> Delete_Time_Sheet(Map<String, Object> data) throws SQLException, ClassNotFoundException {
		DatabaseUtil dbutil = new DatabaseUtil();
		Connection connection = dbutil.connectDB();
		Map<String, Object> responseBodyStr = new HashMap<String, Object>();
		String Sheet_id = (String) data.get("Sheet_id");
